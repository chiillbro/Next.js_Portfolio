    ...
    emailjs
      .send(
...

        {
          ...
          limitRate: {
            throttle: 5000, //you can not send more than 1 email per 5 secs
          },
        }
      )
      .then(
    ...
    <>
      ...
      >
        <motion.input
          ...
          className="w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 mybackground"
        />
        {errors.name && (
