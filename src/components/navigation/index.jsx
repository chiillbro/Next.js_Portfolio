          ...
          return size && size >= 480 ? (
            ...
            <>
              <motion.div
                ...
                initial="hidden"
                animate="show"
                className="w-full px-2.5 flex-col flex items-start space-y-4 justify-center relative"
              ...
              <motion.div
                ...
                initial="hidden"
                animate="show"
                className="w-full px-2.5 flex flex-col items-end space-y-4 justify-center relative group"
